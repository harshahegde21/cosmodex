          ...
          {[
            ...
            return (
              <motion.div
                 ...
                 transition={{ 
                   y: { duration: 6 + (i % 3), repeat: Infinity, ease: "easeInOut", delay: i * 0.5 }
                 }}
              ...
              >
                 <div className={`relative w-full h-full transition-all duration-1000 ${isLit ? (isActive ? 'opacity-100 drop-shadow-[0_0_15px_rgba(238,204,255,0.8)]' : 'opacity-95') : 'opacity-50'} flex items-center justify-center`}>
