...
import { Calendar, Edit, Zap, Shield, Award, Flame, Plus, X, Globe, Link, MessageCircle, Video, Share2 } from 'lucide-react';
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-[#0a0518]">
      ...
      <div className="absolute inset-[-10%] w-[120%] h-[120%] pointer-events-none">
        ...
        {/* Top Left Planet / Distant Ambient Elements */}
        <motion.div
           animate={{ 
             y: [0, 15, 0],
             rotate: [0, 5, 0]
          ...
          <div className="flex-1 flex flex-col cosmo-glass-panel border border-white/10 rounded-[32px] pb-10 overflow-hidden relative">
            ...
            <div className="px-6 sm:px-10 mt-20">
              ...
              <div className="flex items-center gap-2 text-white/50 text-sm mt-5 font-medium">
                 <Calendar size={16} /> Joined May 2026
              </div>
            ...
            <div className="cosmo-glass-panel p-6 border border-white/15 drop-shadow-2xl">
              <div className="flex items-center gap-4 border-b border-white/10 pb-5 mb-5 relative">
                 <div>
                   ...
                   <p className="text-sm font-medium text-white/60 font-mono">Level 1</p>
                 </div>
                 {/* Decorative soft glow highlight behind header */}
              ...
              <div className="grid grid-cols-2 gap-y-6 gap-x-4">
                 <div className="flex items-start gap-3">
                   ...
                   <div>
                     <p className="font-bold text-white text-xl leading-none">95</p>
                 ...
                 <div className="flex items-start gap-3">
                   ...
                   <div>
                     <p className="font-bold text-white text-base leading-none mt-0.5">Bronze</p>
                 ...
                 <div className="flex items-start gap-3">
                   ...
                   <div>
                     <p className="font-bold text-white text-xl leading-none">1</p>
                 ...
                 <div className="flex items-start gap-3">
                   ...
                   <div>
                     <p className="font-bold text-white text-xl leading-none">0</p>
              ...
              <div className="mt-6 pt-5 border-t border-white/10">
                 <div className="flex justify-between items-end mb-2.5">
                   <div>
                     ...
                     <p className="text-sm font-medium text-white/80"><span className="text-white font-bold">95</span> / 200 ✦</p>
                   </div>
                   <p className="text-sm font-medium text-white/60 mb-0.5">to Silver</p>
                 </div>
            ...
            >
              ...
              <div className="relative flex flex-col h-full max-h-[80vh]">
                ...
                <div className="overflow-y-auto pr-2 custom-scrollbar space-y-6 pb-6">
                  ...
                  <div>
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-2 custom-scrollbar">
                      {AVATARS.map((url, i) => (
                        <button 
                          key={`avatar-${i}`} 
                          onClick={() => setEditData({...editData, avatar: url})}
                          className={`relative flex-shrink-0 w-16 h-16 rounded-full overflow-hidden border-2 transition-all ${editData.avatar === url ? 'border-fuchsia-400 scale-105' : 'border-transparent opacity-50 hover:opacity-100'}`}
                        >
                  ...
                  {/* Banner Picker */}
                  <div>
                    <label className="block text-sm font-medium text-white/60 mb-3">Banner</label>
                    <div className="flex gap-3 overflow-x-auto pb-2 custom-scrollbar">
                      {BANNERS.map((url, i) => (
                        <button 
                          key={`banner-${i}`} 
                          onClick={() => setEditData({...editData, banner: url})}
                          className={`relative flex-shrink-0 w-32 h-16 rounded-xl overflow-hidden border-2 transition-all ${editData.banner === url ? 'border-fuchsia-400 scale-105' : 'border-transparent opacity-50 hover:opacity-100'}`}
                        >
                ...
                <div className="mt-4 pt-4 border-t border-white/10 flex justify-end gap-3 flex-shrink-0">
                  <button 
                    onClick={() => setIsEditing(false)}
                    className="px-5 py-2.5 rounded-xl font-medium text-white/70 hover:text-white hover:bg-white/5 transition-all"
                  >
                    Cancel
                  </button>
                  <button 
                    onClick={handleSaveProfile}
                    className="px-6 py-2.5 bg-gradient-to-r from-[#E873C3] to-[#8D37D6] rounded-xl font-medium text-white shadow-[0_0_20px_rgba(141,55,214,0.4)] hover:opacity-90 transition-opacity"
                  >
                    Save Changes
                  </button>
                </div>
